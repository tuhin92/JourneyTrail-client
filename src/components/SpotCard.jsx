const SpotCard = ({spot}) => {
    const {tourists_spot_name, image, country_Name, location, short_description, average_cost, seasonality, travel_time, totaVisitorsPerYear, userEmail, userName} = spot;
    return (
        <div>
